...
| Project website | [Service Discovery](https://steeltoe.io/docs/v4/discovery/index.html) by [Steeltoe](https://steeltoe.io/) |
| --- | --- |
| Project package | <sub>[![Project package](https://img.shields.io/nuget/v/Steeltoe.Discovery.Eureka?logo=nuget&label=Steeltoe.Discovery.Eureka)](https://www.nuget.org/packages/Steeltoe.Discovery.Eureka/ "Steeltoe.Discovery.Eureka package")</sub> |
